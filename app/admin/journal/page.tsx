        ...
        <div className="adminWelcome">
          <div>
            ...
            <p className="muted">
              ...
              предупреждения, инициализация.
            </p>

            <p className="muted healthNote">
              Журнал хранится только в памяти
              Node-процесса (кольцевой буфер, последние
              500 записей) и очищается при рестарте или
              деплое — это НЕ постоянный audit log.
              Worker'ы (OHLCV/Snapshot) — отдельные
              процессы, их события сюда не попадают.
              Секреты (строки подключения, токены,
              пароли, ключи) скрываются автоматически.
            </p>
          </div>
        </div>
