 ...
 * Реальное поле Candle.closeTime в БД nullable и не
 * используется: канонические границы проекта (freshness)
 * строятся на openTime, поэтому мы НЕ имитируем
 * несуществующее гарантированное поле, а вычисляем
 * границу детерминированно.
 *
